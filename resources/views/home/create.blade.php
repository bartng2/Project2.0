    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-12">
        <div class="card card-registration card-registration-2" style="border-radius: 15px;">
        	<form action="<?= route('qlns.store') ?>" method="POST" enctype="multipart/form-data">
                  @csrf
                ...
                <div class="p-5">
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4 pb-2">
                      ...
                      <div class="form-outline">
                        <input type="text" class="form-control form-control-lg" name="MaNv" />
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4 pb-2">
                      ...
                      <div class="form-outline">
                        <input name="GioiTinh" type="text" class="form-control form-control-lg" />
              ...
              <div class="col-lg-6 bg-indigo text-white">
                <div class="p-5">
                  ...
                  <button type="submit" class="btn btn-light btn-lg"
                    data-mdb-ripple-color="dark">Thêm mới</button>
                    <button type="cancel" class="btn btn-light btn-lg"
